...
function sendMoney() {
  ...
  if (enterAmount > 500000) {
    ...
    var textNode = document.createTextNode(
      `${enterAmount} ₿ Transferred Successfully to ${enterName} on ${Date()}.`
    );
...
function donate() {
  var person = alert(
    "Thank you for your kind gesture. You are a true treasure to me :) or you can just do it : bc1qhjqqeanujzl7wva3kv2t0wqa0dde84t97tmuhn"
  );
}
